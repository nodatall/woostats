...
module.exports = async function fetchWooDaoBancorV3Balance({ tokenTickers }) {
  ...
  const poolContract = new web3.eth.Contract(bancorTokenContractABI, wooBancorContractAddress)
  const weiBntWooBalance = await poolContract.methods.balanceOf(wooDaoEthAddress).call()
  const networkInfoContract = new web3.eth.Contract(bancorNetworkInfoABI, '0x8E303D296851B320e6a697bAcB979d13c9D6E760')
